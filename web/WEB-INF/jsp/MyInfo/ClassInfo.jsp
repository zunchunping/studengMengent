...
<script src="<%=path%>/statics/css/jBox/jquery-1.4.2.min.js"
	type="text/javascript"></script>
<script src="<%=path%>/statics/js/jquery.jBox-2.3.min.js"
	type="text/javascript"></script>
			...
			<div class="rightbox">
				...
				<div class="morebt">
					...
					<ul id="ulStudMsgHeadTab">
						...
						<li><a class="tab2" onclick="" href="Objection.aspx.html">我的异议</a>
						</li>
					</ul>
				...
				<div class="cztable">
					<table border="0" cellspacing="0" cellpadding="0" width="100%">
						...
						<tr>
							...
							<td align="right"><div align="left">
									<a target="_blank"
										...
										border="0" src="http://wpa.qq.com/pa?p=2::41" alt="点击这里给我发消息" />
									</a>
								</div>&nbsp;</td>
						</tr>
						...
						<tr>
							...
							<td colspan="5"><input value="满意" checked="checked"
								type="radio" name="workAssess" />满意 <input value="一般"
								type="radio" name="workAssess" />一般 <input value="差"
								type="radio" name="workAssess" />差</td>
						</tr>
						<tr>
							<td rowspan="3" align="right">问题反馈：</td>
							<td colspan="5"><input value="4" checked="checked"
								type="radio" name="problemType" />提问 <input value="1"
								type="radio" name="problemType" />投诉</td>
						</tr>
						<tr>
							<td colspan="5"><textarea name="problemContent"
									id="problemContent" cols="80" rows="6" class="input_2"></textarea>
							</td>
						</tr>
						<tr>

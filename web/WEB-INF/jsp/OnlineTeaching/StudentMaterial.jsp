			...
			<div class="page">
				...
				<div class="blog_nav">
					<ul>
						...
						<li><a href="StudentMaterial.aspx.html">资料中心</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="box mtop">
			<div class="leftbox">
				<div class="l_nav2">
					...
					<div class="cdlist">
						<div>
							<a href="StudentMaterial.aspx.html">资料下载</a>
						</div>
						<div>
							<a href="StudentStudyRecordList.aspx.html">学习历程</a>
						</div>
					</div>
				...
				<div class="fllist">
					...
					<div class="cztable">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td><img src='<%=path%>/statics/Images/FileIco/doc.gif' />
								</td>
								...
								<td><a
									...
									target="_blank"> <img src="<%=path%>/statics/Images/down.gif" alt="点击下载" />
								</a></td>
							</tr>

							<tr>
								<td><img src='<%=path%>/statics/Images/FileIco/default.jpg' />
								</td>
							...
							<tr>
								<td><img src='../Images/FileIco/doc.gif' />
								</td>

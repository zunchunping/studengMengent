		...
		<div class="bgh">
			<div class="page">
				...
				<div class="topxx">
					...
					<a href="../StudentInfor/systemMsge.aspx.html"> 通知</a> <a
						href="ChangePasswd.aspx.html">密码修改</a> <a onclick="loginOut()"
			...
			<div class="leftbox">
				<div class="l_nav2">
					...
					<div class="cdlist">
						...
						<div>
							<a href="../StudentInfor/Letter.aspx.html">短信息</a>
						</div>
						<div>
							<a href="../StudentInfor/systemMsge.aspx.html">学院通知</a>
						</div>
						<div>

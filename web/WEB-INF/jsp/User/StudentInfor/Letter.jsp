...
<script src="<%=path%>/statics/js/Script/Data.js" type="text/javascript"></script>
			...
			<div class="page">
				<div id="logo">
					<a href="../../Index.aspx.html"> <img
						src="<%=path%>/statics/Student/logo.gif" alt="" width="165" height="48" />
					</a>
				</div>
				<div class="topxx">
					...
					<a href="systemMsge.aspx.html"> 通知</a> <a
						href="../Account/ChangePasswd.aspx.html">密码修改</a> <a
			...
			<div class="leftbox">
				<div class="l_nav2">
					...
					<div class="cdlist">
						...
						<div>
							<a href="Letter.aspx.html">短信息</a>
						</div>
						<div>
							<a href="systemMsge.aspx.html">学院通知</a>
						</div>
						<div>
			...
			<div class="rightbox">
				...
				<div class="morebt">
					...
					<ul id="ulStudMsgHeadTab">
						...
						<li><a class="tab2" onclick=""
							href="../../MyInfo/ClassInfo.aspx.html">班级信息</a>
						</li>
						<li><a class="tab1" onclick=""
							href="../User/StudentInfor/Letter.aspx.html">短信息</a>
						</li>
						<li><a class="tab2" onclick="" href="systemMsge.aspx.html">通知<span
								style="color:#ff0000; padding-left:5px;" id="unreadSysMsgCount"></span>
						</a>
						</li>
						<li><a class="tab2" onclick=""
							href="../../MyInfo/Objection.aspx.html">我的异议</a>
						</li>
					</ul>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr style="height: 28px" class="tdbg" align="center">
							<td colspan="13" align="left"
								style="color: Red; font-weight:bold;">暂无信息!</td>
						</tr>
				...
				<div class="cztable">
					...
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td width="15%" align="right"><div align="right">信息主题：
								</div>
							</td>
							<td><input id="Ctitle" size="20" name="Ctitle"
								class="input_2" />
							</td>
						</tr>
						<tr>
							<td width="15%" align="right"><div align="right">信息类型：
								</div>
							</td>
						...
						<tr>
							<td width="15%" align="right"><div align="right">信息内容：
								</div>
							</td>
							<td><textarea name="Ccontent" cols="80" rows="5"
									id="Ccontent" class="input_2"></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center">
								<div align="center">
									<input type="submit" value="提交"
										onclick="saveClick('7c50f70a-775b-4aef-8bf2-5010ec612c0d')"
										class="input2" /> <input type="submit" value="返回"
										onclick="returnIndex()" class="input2" />
								</div></td>
						</tr>
					</table>
				</div>
